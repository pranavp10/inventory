    ...
    <div class="wrapper">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    <li class="">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="../../../inventory/home_users.php"><i class="fa fa-user-plus"></i> Users</a></li>
                        </ul>
                    </li>
                    <!-- ############################################################################################################ -->
        ...
        <div class="content-wrapper">
            ...
            <div class="info-box-content">
              <span class="info-box-number">Inventory Management</span>
              <span class="info-box-">Manage your inventory and check stock levels in real-time. Receive low inventory notifications and generate purchase orders to replenish </span>
            </div>
          </div>
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-">With integrated purchase orders, you can easily replenish your inventory levels by ordering more stock and even track when those new items will</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-number">Item Variations</span>
              <span class="info-box-">Organize inventory items using custom attributes such as size, color, and location. View how many you have globally or at each location.</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-number">Invoices & Estimates</span>
              <span class="info-box-">Create beautiful, professional invoices & estimates in just a few seconds and then instantly email them as PDF's directly to your customers or prospects.</span>
            </div>
            <!-- /.info-box-content -->
          </div>
            </section>
