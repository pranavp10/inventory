                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title" id="addNewCustomersTitle"> Add New Customer </h1>
                        ...
                        <div class="modal-body">
                            <form action="../../../pages/hr/master/add_employee.php" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-8">
                                        <div class="form-group">
                                            <label for="customerName">Company Name OR Customer Name</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input type="email" name="customerEmail" class="form-control" id="customerEmail" placeholder="Jon@gmail.com" required>
                                        </div>
                                    </div>
                                    <div class="col-xs-4">
                                        <div class="form-group">
                                            <label for="employeeAddress">Address</label>
                                            <textarea class="form-control" rows="3" placeholder="Enter The customer Address"></textarea>
                                        </div>
                                    </div>
                                </div>
                        </div>
