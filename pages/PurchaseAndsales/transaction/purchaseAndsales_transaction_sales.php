...
<body class="hold-transition skin-blue sidebar-mini sidebar-collapse">
    <div class="wrapper">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="active treeview">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li class="active"><a href="../../../pages/PurchaseAndsales/transaction/purchaseAndsales_transaction_sales.php"><i class="fa fa-bar-chart" aria-hidden="true"></i></i> Sales</a></li>
                                </ul>
                            </li>
                            <li class="treeview">
                                <a href="#"><i class="fa fa-link"></i> Processing
        ...
        <div class="content-wrapper">
            <?
            if (isset($_SESSION['addSales'])) {
                if (($_SESSION['addSales'] == 'yes')) {
                    $newSalesAdded =  '<div class="alert alert-success alert-dismissible" id="newSalesAddedAlert" >
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                            <strong>New Sales Added!</strong>
                            </div>   <script>setTimeout(fade_out, 5000);
                            function fade_out() {
                            $("#newSalesAddedAlert").fadeOut().empty();
                            }</script>';
                    unset($_SESSION['addSales']);
                    echo $newSalesAdded;
                } else {
                    $newSalesNotAdded =  '<div class="alert alert-danger alert-dismissible" id="newSalesNotAddedAlert" >
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                            <strong>New Sales has not neen saved because of the some missing column !!! </strong>
                            </div>   <script>setTimeout(fade_out, 5000);
                            function fade_out() {
                            $("#newSalesNotAddedAlert").fadeOut().empty();
                            }</script>';
                    unset($_SESSION['addSales']);
            ...
            if (isset($_SESSION['deleteSales'])) {
                if (($_SESSION['deleteSales'] == 'yes')) {
                    $SalesDeleted =  '<div class="alert alert-warning alert-dismissible" id="SalesDeletedAlert" >
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                            <strong>Sales Deleted!!!.</strong> 
                            </div>   <script>setTimeout(fade_out, 5000);
                            function fade_out() {
                            $("#SalesDeletedAlert").fadeOut().empty();
                            }</script>';
                    unset($_SESSION['deleteSales']);
                    echo $SalesDeleted;
                } else {
                    $SalesNotDeleted =  '<div class="alert alert-danger alert-dismissible" id="SalesNotDeletedAlert" >
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                            <strong>Sales </strong> cannot be deleted  because the designation is used by the one of the employee So you cannot perform this action. 
                            </div>   <script>setTimeout(fade_out, 10000);
                            function fade_out() {
                            $("#$SalesNotDeletedAlert").fadeOut().empty();
                            }</script>';
                    unset($_SESSION['deleteSales']);
                    echo $SalesNotDeleted;
                }
            }
            ?>
            <!-- Delete addItem -->
            <div class="modal fade" id="deleteSalesList" tabindex="-1" role="dialog" aria-labelledby="deleteSalesList" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title" id="deleteSalesListHeading"> Delete Item </h1>
                ...
                <div class="row">
                    <div class="col-xs-3">
                        <div class="form-group">
                            <label for="discountId">Select Customer:</label>
                    ...
                    <div class="col-xs-3">
                        <label for="toDate">Search Sales:</label>
                        <div class="form-group">
                            <button type="button" class="btn btn-primary" id="searchSalesList">
                                <strong><i class="fa fa-search"></i> Sales List</strong></button>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                ...
                                <div class="box-tools">
                                    <button type="button" class="btn btn-primary" onClick="location.href='../../../pages/PurchaseAndsales/transaction/add_sales.php'">
                                        <strong><i class="fa fa-plus"></i> Add Sales </strong></button>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
        ...
        <script src="../../../scripts/PurchaseAndsales/purchaseAndsales_transaction_sales.js"></script>
        <!-- ###################################################################################################################################### -->
</body>
