...
<body class="hold-transition skin-blue sidebar-mini  sidebar-collapse">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content">
                <form action="../../../pages/PurchaseAndsales/transaction/save_edit_sales_list.php" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-3">
                                            <div class="form-group">
                                                ...
                                                <input style="background-color: transparent; border: transparent;" type="text" name="salesId" value="<? echo $_GET['trNumber']; ?>" class="form-control" id="salesId" readonly required>
                                            </div>
                                        </div>
                                        <div class="col-xs-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="customerId" id="customerId">
                                                    ...
                                                    if ($rawDate = $connect->query($sqlDisplayCustomer)) {
                                                        while ($displayCustomer = $rawDate->fetch_assoc()) {
                                                            ...
                                                            if ($customer_name === $_GET['customerId']) {
                                                                ?>
                                                                <option value="<? echo $customer_Id ?>" selected><? echo $customer_name ?></option>
                                                            <? } else { ?>
                                        ...
                                        <div class="col-xs-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control pull-right" value="<? echo $_GET['date']; ?>" name="salesDate" id="salesDate">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-3">
    ...
    <!-- ###################################################################################### -->
    <!-- my scripts -->
    <script src="../../../scripts/PurchaseAndsales/edit_sales_list.js"></script>
    <!-- ###################################################################################################################################### -->
</body>
