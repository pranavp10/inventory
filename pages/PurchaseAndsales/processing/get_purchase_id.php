...
if ($_POST['supplierId'] != NULL && $_POST['paymentDate'] !=NULL) {
    ...
    $id= $_POST['supplierId'];
    $sqlSelect = "SELECT purchase.purchase_id , (purchase.total_amount_tax- SUM(ppList.amount_paid)) AS amount_paid FROM `purchase` AS purchase LEFT JOIN purchase_payment_list AS ppList ON purchase.purchase_id= ppList.purchase_id
