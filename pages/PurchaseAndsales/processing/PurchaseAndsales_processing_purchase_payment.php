                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        <button type="button" class="btn btn-primary" onClick="location.href='../../../pages/PurchaseAndsales/processing/make_purchase_payment.php'">
                                            <strong><i class="fa fa-plus"></i> Make Purchase Payment</strong></button>
                                    </div>
