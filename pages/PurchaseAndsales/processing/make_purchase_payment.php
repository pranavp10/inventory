...
<body class="hold-transition skin-blue sidebar-mini  sidebar-collapse">
                    ...
                    <li class="active treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="active treeview">
                                ...
                                <ul class="treeview-menu">
                                    <li class="active"><a href="../../../pages/PurchaseAndsales/processing/PurchaseAndsales_processing_purchase_payment.php"><i class="fa fa-money"></i> Purchase Payment</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Make Purchase Payment</h3>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-xs-2">
                                            <div class="form-group">
                                                <label for="purchaseId">Payment ID</label>
                                        ...
                                        <div class="col-xs-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control pull-right" name="paymentDate" id="paymentDate">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-2">
                                        ...
                                        <div class="col-xs-2">
                                            <div class="form-group" id="checkNoDisplay" hidden>
                                                <label for="checkNo">check No</label>
                                                <div class="input-group">
                                                    <input type="text" class="form-control pull-right" name="checkNo" id="checkNo">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <table class="table table-bordered table-hover" id="tableData">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td id="0">1</td>
                                                <td> <select class="form-control purchaseId" name="purchaseId[]" id="purchaseId0">
                                                        <option value="-Select-">-Select-</option>
                                                    </select>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <input style="background-color: transparent; border: transparent;" type="text" name="balance[]" class="form-control balance" id="balance0" readonly required>
                                                </td>
                                                <td>
                                                    <div class="input-group">
                                                        <input type="text" name="amountToPay[]" onkeypress="return isNumberKey(event)" class="form-control amountToPay" id="amountToPay0"  required>
                                                    </div>
                                                </td>
                                                <td>
                                                    <input style="background-color: transparent; border: transparent;" type="text" name="remainingAmount[]" class="form-control remainingAmount" id="remainingAmount0" readonly required>
                                                </td>
                                        ...
                                        <tfoot>
                                            <td colspan="2">Ground Total Of Supplier :-</td>
                                            <td>
                                                <input style="background-color: transparent; border: transparent;" type="text" name="totalAmountOfSupplier" class="form-control totalAmountOfSupplier" id="totalAmountOfSupplier" readonly  required>
                                            </td>
                                            <td>
                                                <input style="background-color: transparent; border: transparent;" type="text" name="totalAmountOfPurchase" class="form-control totalAmountOfPurchase" id="totalAmountOfPurchase" readonly required>
                                            </td>
                                            <td>
                                                <input style="background-color: transparent; border: transparent;" type="text" name="totalAmountWithTaxOfPurchase" class="form-control totalAmountWithTaxOfPurchase" id="totalAmountWithTaxOfPurchase" readonly required>
                                            </td>
                                            <td>
                                                <input style="background-color: transparent; border: transparent;" type="text" name="totalAmountWithTaxOfPurchase" class="form-control totalAmountWithTaxOfPurchase" id="totalAmountWithTaxOfPurchase" readonly required>
                                            </td>
                                    ...
                                    <div class="box-tools">
                                        <button type="button" class="btn btn-primary" id="newRow">
    ...
    <!-- ###################################################################################### -->
    <!-- my scripts -->
    <script src="../../../scripts/PurchaseAndsales/make_purchase_payment.js"></script>
    <!-- ###################################################################################################################################### -->
</body>
