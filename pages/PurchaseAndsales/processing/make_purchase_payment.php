                                        ...
                                        <div class="row">
                                            <div class="col-xs-2">
                                                <div class="form-group">
                                                    ...
                                                    <input style="background-color: transparent; border: transparent;" type="text" name="paymentId" class="form-control" id="paymentId" readonly required>
                                                </div>
                                            </div>
                                            <div class="col-xs-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-xs-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control pull-right" name="paymentDate" id="paymentDate" disabled>
                                                    </div>
                                                </div>
                                            </div>
